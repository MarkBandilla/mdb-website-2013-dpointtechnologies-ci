...
<body style="height: 400px;"> 
	<div class="various"> 
	<img src="<?php echo base_url(); ?>products/IMG/p6-1.jpg" style="float:left;" />
    <div class="right">
    	<h1>A-181B-SE</h1>
        <i>"High Specs Choice with Varifocal lens. Capture larger areas when zoomed out. Perfect for large spaces."</i><br /><br />
        <b>Key Features:</b>
        ...
        <div class="total">
            <h1 style="float: left;">SRP : <font color="#D00B2C">Php 5,799</font></h1>
            <form action="cart" method="post" style="float: right;">
            	<input type="hidden" name="id" value="img6">
