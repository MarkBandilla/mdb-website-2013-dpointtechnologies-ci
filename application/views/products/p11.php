...
<body style="height: 400px;"> 
	<div class="various"> 
	<img src="<?php echo base_url(); ?>products/IMG/p11-1.jpg" style="float:left;" />
    <div class="right">
    	<h1>DP-783</h1>
        <i>"Top-of-the-line IP Camera for outdoor use. High Specs on all features."</i><br /><br />
        <b>Key Features:</b>
        ...
        <div class="total">
            <h1 style="float: left;">SRP : <font color="#D00B2C">Php 18,499</font></h1>
            <form action="cart" method="post" style="float: right;">
            	<input type="hidden" name="id" value="img11">
